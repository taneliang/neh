...
cloudSql.setNothingHandler(
  new RedirectHandler('navigates to Cloud SQL instances', `${cloudSqlBaseUrl}/instances`),
);
cloudSql.addHandler(
  'i',
  new RedirectHandler('navigates to Cloud SQL instances', `${cloudSqlBaseUrl}/instances`),
...
cloudSql.addHandler(
  'create',
  new RedirectHandler(
    'navigates to Cloud SQL create instance',
    `${cloudSqlBaseUrl}/choose-instance-engine`,
  ),
);
...
cloudRun.addHandler(
  'services',
  new RedirectHandler('navigates to Cloud Run services', cloudRunBaseUrl),
);
cloudRun.addHandler(
  'j',
  new RedirectHandler('navigates to Cloud Run jobs', `${cloudRunBaseUrl}?tab=jobs`),
);
cloudRun.addHandler(
  'jobs',
  new RedirectHandler('navigates to Cloud Run jobs', `${cloudRunBaseUrl}?tab=jobs`),
...
artifactRegistry.setNothingHandler(
  new RedirectHandler('navigates to Artifact Registry', arBaseUrl),
);
artifactRegistry.addHandler(
  'r',
  new RedirectHandler('navigates to Artifact Registry repositories', arBaseUrl),
);
artifactRegistry.addHandler(
  'repos',
  new RedirectHandler('navigates to Artifact Registry repositories', arBaseUrl),
...
gke.addHandler(
  'workloads',
  new RedirectHandler('navigates to GKE workloads', `${gkeBaseUrl}/workload`),
);
gke.addHandler('gw', new RedirectHandler('navigates to GKE gateways', `${gkeBaseUrl}/gateways`));
gke.addHandler(
  'gateways',
  new RedirectHandler('navigates to GKE gateways', `${gkeBaseUrl}/gateways`),
);
...
gcs.setNothingHandler(
  new RedirectHandler('navigates to Cloud Storage buckets', `${gcsBaseUrl}/browser`),
);
gcs.addHandler(
  'b',
  new RedirectHandler('navigates to Cloud Storage buckets', `${gcsBaseUrl}/browser`),
...
gcs.addHandler(
  't',
  new RedirectHandler('navigates to Cloud Storage transfer', `${gcsBaseUrl}/transfer`),
);
gcs.addHandler(
  'transfer',
  new RedirectHandler('navigates to Cloud Storage transfer', `${gcsBaseUrl}/transfer`),
...
functions.setNothingHandler(
  new RedirectHandler('navigates to Cloud Functions', `${functionsBaseUrl}/list`),
);
functions.addHandler(
  'l',
  new RedirectHandler('navigates to Cloud Functions list', `${functionsBaseUrl}/list`),
);
functions.addHandler(
  'list',
  new RedirectHandler('navigates to Cloud Functions list', `${functionsBaseUrl}/list`),
...
functions.addHandler(
  'create',
  new RedirectHandler('navigates to Cloud Functions create', `${functionsBaseUrl}/add`),
);
...
pubsub.setNothingHandler(
  new RedirectHandler('navigates to Pub/Sub topics', `${pubsubBaseUrl}/topic/list`),
);
pubsub.addHandler(
  't',
  new RedirectHandler('navigates to Pub/Sub topics', `${pubsubBaseUrl}/topic/list`),
...
pubsub.addHandler(
  's',
  new RedirectHandler('navigates to Pub/Sub subscriptions', `${pubsubBaseUrl}/subscription/list`),
);
pubsub.addHandler(
  'subscriptions',
  new RedirectHandler('navigates to Pub/Sub subscriptions', `${pubsubBaseUrl}/subscription/list`),
...
bigquery.addHandler(
  'j',
  new RedirectHandler('navigates to BigQuery job history', `${bqBaseUrl}?tab=job_history`),
);
bigquery.addHandler(
  'jobs',
  new RedirectHandler('navigates to BigQuery job history', `${bqBaseUrl}?tab=job_history`),
...
iam.addHandler(
  'sa',
  new RedirectHandler('navigates to IAM service accounts', `${iamBaseUrl}/serviceaccounts`),
);
iam.addHandler(
  'serviceaccounts',
  new RedirectHandler('navigates to IAM service accounts', `${iamBaseUrl}/serviceaccounts`),
...
billing.addHandler(
  'overview',
  new RedirectHandler('navigates to GCP billing overview', billingBaseUrl),
);
billing.addHandler(
  'r',
  new RedirectHandler('navigates to GCP billing reports', `${billingBaseUrl}/reports`),
);
billing.addHandler(
  'reports',
  new RedirectHandler('navigates to GCP billing reports', `${billingBaseUrl}/reports`),
...
billing.addHandler(
  'b',
  new RedirectHandler('navigates to GCP billing budgets', `${billingBaseUrl}/budgets`),
);
billing.addHandler(
  'budgets',
  new RedirectHandler('navigates to GCP billing budgets', `${billingBaseUrl}/budgets`),
...
logging.setNothingHandler(
  new RedirectHandler('navigates to Cloud Logging explorer', `${loggingBaseUrl}/query`),
);
logging.addHandler(
  'e',
  new RedirectHandler('navigates to Cloud Logging explorer', `${loggingBaseUrl}/query`),
...
logging.addHandler(
  'm',
  new RedirectHandler('navigates to Cloud Logging metrics', `${loggingBaseUrl}/metrics`),
);
logging.addHandler(
  'metrics',
  new RedirectHandler('navigates to Cloud Logging metrics', `${loggingBaseUrl}/metrics`),
...
monitoring.setNothingHandler(
  new RedirectHandler('navigates to Cloud Monitoring', monitoringBaseUrl),
);
monitoring.addHandler(
  'd',
  new RedirectHandler(
    'navigates to Cloud Monitoring dashboards',
    `${monitoringBaseUrl}/dashboards`,
  ),
);
monitoring.addHandler(
  'dashboards',
...
monitoring.addHandler(
  'a',
  new RedirectHandler('navigates to Cloud Monitoring alerting', `${monitoringBaseUrl}/alerting`),
);
monitoring.addHandler(
  'alerting',
  new RedirectHandler('navigates to Cloud Monitoring alerting', `${monitoringBaseUrl}/alerting`),
...
compute.setNothingHandler(
  new RedirectHandler('navigates to Compute Engine instances', `${computeBaseUrl}/instances`),
);
compute.addHandler(
  'i',
  new RedirectHandler('navigates to Compute Engine instances', `${computeBaseUrl}/instances`),
...
compute.addHandler(
  'd',
  new RedirectHandler('navigates to Compute Engine disks', `${computeBaseUrl}/disks`),
);
compute.addHandler(
  'disks',
  new RedirectHandler('navigates to Compute Engine disks', `${computeBaseUrl}/disks`),
...
compute.addHandler(
  'n',
  new RedirectHandler(
    'navigates to Compute Engine networks',
    `${GCP_BASE}/networking/networks/list`,
  ),
);
compute.addHandler(
  'networks',
...
secrets.addHandler(
  'l',
  new RedirectHandler('navigates to Secret Manager secrets list', secretsBaseUrl),
);
secrets.addHandler(
  'list',
  new RedirectHandler('navigates to Secret Manager secrets list', secretsBaseUrl),
...
secrets.addHandler(
  'create',
  new RedirectHandler(
    'navigates to Secret Manager create secret',
    `${secretsBaseUrl}/secret?action=create`,
  ),
);
...
firestore.setNothingHandler(
  new RedirectHandler('navigates to Firestore', `${firestoreBaseUrl}/data`),
);
firestore.addHandler(
  'd',
  new RedirectHandler('navigates to Firestore data', `${firestoreBaseUrl}/data`),
);
firestore.addHandler(
  'data',
  new RedirectHandler('navigates to Firestore data', `${firestoreBaseUrl}/data`),
...
firestore.addHandler(
  'i',
  new RedirectHandler('navigates to Firestore indexes', `${firestoreBaseUrl}/indexes`),
);
firestore.addHandler(
  'indexes',
  new RedirectHandler('navigates to Firestore indexes', `${firestoreBaseUrl}/indexes`),
...
scheduler.addHandler(
  'j',
  new RedirectHandler('navigates to Cloud Scheduler jobs', schedulerBaseUrl),
);
scheduler.addHandler(
  'jobs',
  new RedirectHandler('navigates to Cloud Scheduler jobs', schedulerBaseUrl),
